...
case "${PLATFORM}" in
  ...
  wiiu)   # uses wut
      ...
      sudo dkp-pacman --noconfirm -S wut-linux wiiu-sdl2 devkitPPC wiiu-libromfs wiiu-sdl2_gfx wiiu-sdl2_mixer wiiu-sdl2_image wiiu-sdl2_ttf ppc-zlib ppc-bzip2 ppc-freetype ppc-libpng wiiu-curl-headers
    ;;
esac
